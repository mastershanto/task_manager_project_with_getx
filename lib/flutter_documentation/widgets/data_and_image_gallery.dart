...
class DataImage_Gallery extends StatelessWidget {
  final myPhotoGallery_Cats_1 = [
    {
      "img":
  ...
  final List<Map<String, dynamic>> fruitsList_1 = [
  ...
  final List<Map<String, dynamic>> clothsItemList_1 = [
    {
      "img":
  ...
  final List<Map<String, dynamic>> fruitsNameList_2 = [
    {"fruit": "Apple", "status": ""},
    {"fruit": "Banana", "status": ""},
    {"fruit": "Cherry", "status": ""},
